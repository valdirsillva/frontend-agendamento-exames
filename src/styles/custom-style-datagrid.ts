...
export const customStyles = {
  '& .css-hywy1a-MuiDataGrid-root': {
    border: '1px solid #f7f7f712 !important',
  },

  '& .MuiDataGrid-withBorderColor, .MuiDataGrid-root--densityStandard, .MuiDataGrid-root': {
    border: '1px solid #f7f7f712',
  },
  ...
  '& .MuiDataGrid-footerContainer .MuiTablePagination-selectLabel, .MuiInputBase-root, .MuiTablePagination-displayedRows, .MuiTablePagination-selectIcon, .MuiTablePagination-actions ': {
    color: '#fff'
  },
